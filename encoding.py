...
'''
while storing user photo in database ...store it with the name : user UUID
'''

path_to_images = "/Users/harshpadsala/SnapCircle/encoding_photo"  
images = []
Ids = []
...
if images:
    ...
    print(len(existing_encodings),len(existing_ids))
